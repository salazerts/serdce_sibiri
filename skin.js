...
// Generated Вт апр 2 14:52:03 2024
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._thumbnail_menu.ggTop=-109;
		...
		this._thumbnail_cloner.ggHeight = 95;
	...
	function SkinCloner_thumbnail_cloner_Class(nodeId, parent) {
		...
		this.elementMouseOver=[];
		this.__div=document.createElement('div');
		this.__div.setAttribute('style','position: absolute; left: 0px; top: 0px; width: 98px; height: 95px; visibility: inherit;');
